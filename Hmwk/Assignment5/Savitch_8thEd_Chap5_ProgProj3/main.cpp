 ...
 * Created on January 24, 2015, 10:19 AM
 * Purpose: Homework assignment(Savitch_8thEd_Chap5_ProgProj3)
...
//Global Constants
void getTime(short&,short&,short&,short&);//get current and waiting time
void calTime(short&,short&,short,short);//calculate the time
void cnvTime(short&,short&,char&);//convert 24-hours notation to 12
void optTime(short,short,char);//Output the time
//Function Prototypes
...
void optTime(short hr,short min,char time) {
    //Output the results
    cout<<"The time after waiting period is "<<hr<<":"<<(min<10?"0":"")<<min<<time<<"M"<<endl;
}
